...
Commit directly to `main` — no branch or PR needed. Commits use Conventional Commit format (`type(scope): description`). Single-line subject only with no body; aim for under 50 characters.
